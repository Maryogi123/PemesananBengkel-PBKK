                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('admin.pengguna.destroy', $pengguna->id)); ?>" method="POST">
                                    <a href="<?php echo e(route('admin.pengguna.show', $pengguna->id)); ?>" class="btn btn-sm btn-warning">SHOW</a>
                                    <a href="<?php echo e(route('admin.pengguna.edit', $pengguna->id)); ?>" class="btn btn-sm btn-warning">EDIT</a> <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\PemesananBengkel\resources\views/levelAdmin/user/index.blade.php ENDPATH**/ ?>