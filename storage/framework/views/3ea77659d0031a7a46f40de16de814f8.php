        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="<?php echo e(route('pegawaiBengkel.update', $pegawai->id_pegawai)); ?>" method="POST" >
                          <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\User\PemesananBengkel\resources\views/pegawai/edit.blade.php ENDPATH**/ ?>