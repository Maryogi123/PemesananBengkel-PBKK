                            ...
                            <tbody>
                                @forelse ($customers as $index => $customer)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('customers.destroy', $customer->customer_id) }}" method="POST">
                                                <a href="{{ route('customers.show', $customer->customer_id) }}" class="btn btn-sm btn-success">SHOW</a>
